...
from forecast_bot.handlers.affilate_handlers import router as affilate_router
...
async def run_bot():
    ...
    dp = Dispatcher()
    dp.include_routers(affilate_router, user_router, forecast_user_router, admin_router)
